    ...
    return (
        <header className="fixed inset-x-0 top-0 z-50">
            <div className="mx-auto max-w-7xl px-4">
                <nav className={`mt-3 flex items-center justify-between rounded-2xl border transition-all duration-500 px-6 py-3 ${
                    isScrolled 
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <span className="font-black text-xl text-white tracking-wide">S.A.G.A.R.</span>
